...
def run_challenge_experiment(aggregation_function,
    ...
    gandlf_csv_path = os.path.join(work, f'gandlf_paths_{socket.gethostname()}.csv')
    ...
    transformed_csv_dict = extract_csv_partitions(os.path.join(work, f'gandlf_paths_{socket.gethostname()}.csv'))
    ...
    for col in collaborator_data_loaders:
        ...
        transformed_csv_dict[col]['train'].to_csv(os.path.join(work, f'seg_test_train.csv'))
        transformed_csv_dict[col]['val'].to_csv(os.path.join(work, f'seg_test_val.csv'))
